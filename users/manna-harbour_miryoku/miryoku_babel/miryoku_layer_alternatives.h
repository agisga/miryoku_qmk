...
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_QUOT), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP
...
KC_Q,              KC_QU,             KC_QUE,            KC_COLONQ,         KC_COLONWQ,        U_NU,              U_NU,              LATEX_PAREN,       LATEX_SQBRA,       LATEX_CURLYBRA,             \
RALT(KC_Q),        RALT(KC_P),        RALT(KC_S),        RALT(KC_Y),        U_NU,              U_NU,              AUTOCLOS_QUOTE,    AUTOCLOS_PAREN,    AUTOCLOS_SQBRA,    AUTOCLOS_CURLYBRA,              \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NU,              U_NU,              U_NU,              KC_ELLIPSIS,       U_NU,              \

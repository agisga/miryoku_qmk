...
U_NP,              U_NP,              LT(FUN, KC_DEL),   LT(NUM, KC_BSPC),  LT(SYM, KC_SPC),   LT(MOUSE, KC_TAB), LT(NAV, KC_ENT),   LT(MEDIA, KC_ESC), U_NP,              U_NP
...
LGUI_T(KC_Q),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_M),      \
LT(BUTTON, KC_W),  ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            ALGR_T(KC_SLSH),   LT(BUTTON, KC_QUOT), \
U_NP,              U_NP,              LT(MEDIA, KC_ESC), LT(NAV, KC_ENT),   LT(MOUSE, KC_TAB), LT(SYM, KC_SPC),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL),   U_NP,              U_NP
